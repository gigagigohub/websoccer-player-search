...
WRAPPER = REPO_ROOT / "scripts" / "run_trade_chain_maintenance_sweep.sh"
...
def main() -> int:
    ...
    plist = {
        ...
        "StartCalendarInterval": {"Weekday": 0, "Hour": 7, "Minute": 5},
        "WorkingDirectory": str(REPO_ROOT),
        "StandardOutPath": str(LOG_DIR / "trade-chain-maintenance-sweep.out.log"),
        "StandardErrorPath": str(LOG_DIR / "trade-chain-maintenance-sweep.err.log"),
        "RunAtLoad": False,
    ...
    print("[DONE] schedule: every Sunday at 07:05 JST")
    print(f"[DONE] logs: {LOG_DIR / 'trade-chain-maintenance-sweep.out.log'}")
    return 0
