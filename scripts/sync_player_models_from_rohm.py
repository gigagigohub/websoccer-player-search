...
MODEL_NAME_CANONICAL_MAP = {
    ...
    "香川真司": "香川 真司",
    "香川 真司": "香川 真司",
    # Wikipedia-based canonical spellings for notation variants.
    "ズラタン・イブラヒモビッチ": "ズラタン・イブラヒモヴィッチ",
    "ギャレス・ベイル": "ガレス・ベイル",
    "ゴンザロ・イグアイン": "ゴンサロ・イグアイン",
    "アンドレア・バルザーリ": "アンドレア・バルツァッリ",
    "オリビエ・ジルー": "オリヴィエ・ジルー",
    "ダレイ・ブリント": "デイリー・ブリント",
    "ジオバンニ・ファン・ブロンクホルスト": "ジョバンニ・ファン・ブロンクホルスト",
    "ジョヴァンニ・ファン・ブロンクホルスト": "ジョバンニ・ファン・ブロンクホルスト",
    "ジュセッペ・ベルゴミ": "ジュゼッペ・ベルゴミ",
    "ダグラス・コスタ": "ドウグラス・コスタ",
    "ドウグラス・コスタ・デ・ソウザ": "ドウグラス・コスタ",
    "デイビッド・ベッカム": "デビッド・ベッカム",
    "デイヴィッド・ベッカム": "デビッド・ベッカム",
    "ベンジャマン・パヴァール": "バンジャマン・パヴァール",
    "フェルランド・メンディ": "フェルラン・メンディ",
    "ソン・フンミン": "孫興ミン",
    "孫興慜": "孫興ミン",
    "キリアン・ムバッペ": "キリアン・エムバペ",
...
def normalize_model_name(raw: str) -> str:
    ...
    # Drop parentheses-only disambiguation after a space:
    # "ジョー・アレン (1990年生のサッカー選手)" -> "ジョー・アレン"
    s = re.sub(r"\s+\([^)]*\)$", "", s)
    s = re.sub(r"\s+（[^）]*）$", "", s)
